...
## This will dump the kernel ttgir ptx to dump folder
os.environ['TRITON_KERNEL_DUMP'] = '1'
os.environ['TRITON_DUMP_DIR'] = 'dump'

## This will use the ttgir or ptx in modify folder to override the kernel
...
torch.testing.assert_close(torch_output.cpu().to(torch.float32), triton_output.cpu().to(torch.float32), rtol=1e-2, atol=1e-3, check_dtype=False)
print("Successfully validated results.")
